...
//			list.remove(selectedRow); // 해당 인덱스를 삭제하는 기능
			...
			//model.getValueAt(selectedRow, selectedRow) = Object type 출력(배열의타입)
			int num=(int)model.getValueAt(selectedRow, 0); //option1
			int num2=list.get(selectedRow).getNum(); //option2

...
public class MyFrame extends JFrame implements ActionListener{
	...
	public MyFrame() {
		...
		this.add(btn1);
		// class MyFrame 으로 생선된 객체의 참조값을 가리킨다.
		MyFrame a = this; // type 확인
		JFrame b = this;
		Component c = this;
		Object d = this;
		ActionListener e = this; // xxx ActionListener 인터페이스를 구현하지 않았기 때문!
		// implements ActioncListener => Override =>OOO
